...
def process_image(image):
    ...
    result_text = cv2.putText(result, text1 % (int(line_curv[0]), int(line_curv[1]), int(line_curv[2])),
...
# image = mpimg.imread('./test_images/challenge_video_1.jpg')
...
video_output = './output_videos/challenge_output_first5.mp4'
